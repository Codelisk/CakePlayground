import { config } from "./package_593d7971ef230d4b60deb0207962a05501852618/uno-config.js";
...
if (config.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('package_593d7971ef230d4b60deb0207962a05501852618').then(async function (cache) {
